            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-4 ps-4 d-flex flex-column justify-content-between">
                    <div class="text-center">
                        ...
                        <h4 class="fst-italic text-muted">{{__('ui.category')}} {{ $article_to_check->category->name }}</h4>
                        <p class="fw-bold">{{__('ui.description')}} <br> {{ $article_to_check->description }}</p>
                    ...
                    <div class="d-flex pb-4 justify-content-around">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5 fw-bold" id="exampleModalLabel">{{__('ui.confirmReject')}}
                                        </h1>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <form action="{{ route('reject', ['article' => $article_to_check]) }}"
                                            ...
                                            @csrf
                                            @method('PATCH')
                                            <button class="btn btn-danger rounded-pill mb-3 fw-bold">{{__('ui.conferm')}}</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="modal fade " id="modalAccept" tabindex="-1" aria-labelledby="exampleModalLabel"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5 fw-bold" id="exampleModalLabel">{{__('ui.confirmAccept')}}
                                        </h1>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                    </div>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <form action="{{ route('accept', ['article' => $article_to_check]) }}"
                                            ...
                                            @csrf
                                            @method('PATCH')
                                            <button class="btn btn-success rounded-pill mb-3 fw-bold">{{__('ui.conferm')}}</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
