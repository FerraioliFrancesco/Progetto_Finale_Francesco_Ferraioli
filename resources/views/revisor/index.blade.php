        ...
        <div class="row justify-content-center pt-5">
            ...
            <div class="col-md-4 ps-4 d-flex flex-column justify-content-between">
                ...
                <div class="d-flex pb-4 justify-content-around">
                    <button type="button" class="btn btn-danger rounded-pill mb-3 fw-bold" data-bs-toggle="modal" data-bs-target="#modalReject">
                        Rifiuta
                    </button>
                    <!-- Modal reject -->
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5 fw-bold" id="exampleModalLabel">Conferma rifiuto</h1>
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary rounded-pill mb-3 fw-bold" data-bs-dismiss="modal">Annulla</button>
                    ...
                    <button type="button" class="btn btn-success rounded-pill mb-3 fw-bold" data-bs-toggle="modal" data-bs-target="#modalAccept">
                        Accetta
                    </button>
                    ...
                    <div class="modal fade " id="modalAccept" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5 fw-bold" id="exampleModalLabel">Conferma e pubblica</h1>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body fw-bold">
